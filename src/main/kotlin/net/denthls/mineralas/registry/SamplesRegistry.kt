...
object SamplesRegistry {
    ...
    val LIMONITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("limonite_sample")
    val MALACHITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("malachite_sample")
    val MOZANITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("mozanite_sample")
    val NATIVE_GOLD_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("native_gold_sample")
    val NEVYANSKITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("nevyanskite_sample")
    val PENTLANDITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("pentlandite_sample")
    val QUARTZ_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("quartz_sample")
    val ULTRABASITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("ultrabasite_sample")
    val URANINITE_SAMPLE = SampleBlock(FabricBlockSettings.of(Material.STONE).breakInstantly().sounds(BlockSoundGroup.STONE)).create("uraninite_sample")
