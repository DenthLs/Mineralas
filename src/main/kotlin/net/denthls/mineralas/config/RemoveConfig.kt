...
//    val getFeatures: Features = Features(true, listOf("minecraft:plains")),
    ...
    val modernIndustrializationFeatures: Remove = Remove(true, listOf("antimony", "bauxite", "iridium", "lead", "lignite_coal", "mozanite", "nickel", "salt", "tin", "tungsten", "uranium")),
    val techRebornFeatures: Remove = Remove(true, listOf("bauxite_ore", "cinnabar_ore", "galena_ore", "sapphire_ore", "lead_ore", "ruby_ore", "silver_ore", "tin_ore", "iridium_ore")),
    val powahFeatures: Remove = Remove(true, listOf("uraninite_ore_poor", "uraninite_ore", "uraninite_ore_dense")),
    val defaultFeatures: Remove = Remove(true, listOf("copper", "copper_large", "coal_lower", "coal_upper", "iron_small", "iron_middle", "iron_upper", "gold", "gold_extra",
        "gold_lower", "lapis", "lapis_buried", "redstone", "redstone_lower", "diamond", "diamond_large", "diamond_buried", "emerald")),
